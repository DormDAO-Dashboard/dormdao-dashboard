...
export default function JoinPage() {
  ...
  const inputClass =
    "w-full px-3 py-2.5 text-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-400 dark:text-white placeholder-gray-400 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/40";
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                    Grad Year <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                  </label>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                    Major <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                  </label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                    LinkedIn <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                  </label>
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                    Telegram <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                  </label>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                  Wallet Address <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                </label>
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-400 mb-1.5">
                  Why do you want to join? <span className="text-gray-700 dark:text-gray-400 font-normal">(optional)</span>
                </label>
