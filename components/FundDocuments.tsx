    ...
    <>
      <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/30 overflow-hidden mb-6">
        <div className="px-5 py-4 border-b border-gray-800">
          <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-400">Fund Documents</h2>
        </div>
                ...
                <li key={doc.id} className="flex items-center gap-4 px-5 py-4 opacity-60">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center flex-wrap gap-2 mt-1">
                      ...
                      {doc.school && (
                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-700/60 text-gray-700 dark:text-gray-400">{schoolDisplayName(doc.school)}</span>
                      )}
                      {doc.document_date && (
